@extends('layouts.main', ['activePage' => 'administradores', 'titlePage' => 'Nuevo Administrador'])
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('administradores.store_administrador')}}" method="post" class="form-horizontal">
                    @csrf
                    <div class="card">
